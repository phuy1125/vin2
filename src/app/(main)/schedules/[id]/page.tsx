    ...
    <div className="max-w-6xl mx-auto py-10 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleGeneralInfoChange("duration", e.target.value)
              }
              className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              readOnly
            />
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="flex justify-end mt-6">
          <button className="flex items-center justify-center bg-gradient-to-r from-blue-500 to-blue-900 text-white rounded-lg py-3 px-5 shadow-md hover:shadow-lg transform hover:translate-y-[-2px] transition-all duration-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="font-medium">Thêm lịch trình mới</span>
          </button>
        </div>
      </div>
